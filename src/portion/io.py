...
def from_data(
    ...
    :param data: a list of 4-tuples (left, lower, upper, right).
...
def to_data(interval, conv=None, *, pinf=float("inf"), ninf=float("-inf")):
    """
    Export given interval to a list of 4-tuples (left, lower,
    upper, right).
    ...
    :return: a list of 4-tuples (left, lower, upper, right)
    """
    conv = (lambda v: v) if conv is None else conv
